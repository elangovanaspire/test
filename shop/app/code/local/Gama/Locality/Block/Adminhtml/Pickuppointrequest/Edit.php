...
class Gama_Locality_Block_Adminhtml_Pickuppointrequest_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText ()
    {
        ...
        if ($model->getPickuppointRequestId()) {
            return Mage::helper('gama_locality')->__("Edit Pickup Point Request '%s'", $this->escapeHtml($model->getName()));
        } else {
            return Mage::helper('gama_locality')->__('New Pickup Point Request');
        }
    }
}